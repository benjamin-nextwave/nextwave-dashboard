...
export default function VraagDetailPage() {
  ...
  if (!question) {
    return (
      <main className="p-6">
        <p className="text-muted-foreground">Vraag niet gevonden.</p>
      </main>
    )
  }
            ...
            <div className="p-4 rounded-lg border border-green-500/20 bg-green-500/5">
              ...
              {question.answered_at && (
                <p className="text-xs text-muted-foreground mt-3">
                  Beantwoord op {formatDate(question.answered_at)}
                </p>
              )}
            </div>
          </>
          ...
          <>
            ...
            <form onSubmit={handleSubmitAnswer}>
              ...
              <div className="flex gap-2 mt-3">
                ...
                >
                  {submitting ? 'Versturen...' : 'Verstuur antwoord'}
                </button>
              </div>
            </form>
          </>
